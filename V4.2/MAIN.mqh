...
#include <..\Experts\TrendPower\V4.2\BaseLine.mqh>
#include <..\Experts\TrendPower\V4.2\Exit.mqh>
#include <..\Experts\TrendPower\V4.2\Confirmation.mqh>
#include <..\Experts\TrendPower\V4.2\LastTradeDetails.mqh>
#include <..\Experts\TrendPower\V4.2\ATR.mqh>
...
void MAIN::Execute()
  {
   ...
   {
      target_pips =target_pips + SymbolInfoInteger(SYMBOL, SYMBOL_SPREAD);
   }
