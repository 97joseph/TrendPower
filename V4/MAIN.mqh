...
#include <..\Experts\TrendPower\V4\BaseLine.mqh>
#include <..\Experts\TrendPower\V4\Exit.mqh>
#include <..\Experts\TrendPower\V4\Confirmation.mqh>
#include <..\Experts\TrendPower\V4\LastTradeDetails.mqh>
#include <..\Experts\TrendPower\V4\ATR.mqh>
...
void MAIN::Execute()
  {
   ...
   int confirmation_direction = confirmation.Confirmation_no_direction(INTER_TRADE_PIPS,lastDetails.last,baseline_direction,baseline.last_ma_price);
