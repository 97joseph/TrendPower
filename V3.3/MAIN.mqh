...
#include <..\Experts\TrendPower\V3.3\BaseLine.mqh>
#include <..\Experts\TrendPower\V3.3\Exit.mqh>
#include <..\Experts\TrendPower\V3.3\Confirmation.mqh>
#include <..\Experts\TrendPower\V3.3\LastTradeDetails.mqh>
...
void MAIN::Execute()
  {
   ...
   int confirmation_direction = confirmation.Execute(INTER_TRADE_PIPS,lastDetails.last,baseline_direction);
