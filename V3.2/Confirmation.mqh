...
public:
   ...
   int               Confirmation_no_direction(int PIP_GAP,LastTrade &last, int direction);
...
//|                                                                  |
//+------------------------------------------------------------------+
int Confirmation::Confirmation_no_direction(int PIP_GAP,LastTrade &last, int direction)
  {
   GAP = PIP_GAP;
